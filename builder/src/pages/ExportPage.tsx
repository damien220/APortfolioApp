...
export default function ExportPage() {
  ...
  async function handleDownload() {
    ...
    if (!parsed.success) {
      setError(
        "Some fields are invalid. Please fix them in the editor before exporting.",
      );
      return;
    }
    setLoading(true);
    ...
    <main className="export-page">
      <div className="export-container">
        ...
        <p className="export-intro">
          Download your portfolio as a ready-to-deploy ZIP. Then follow one of
          the steps below to publish it.
        </p>
        ...
        <div className="deploy-cards">
          <div className="deploy-card deploy-card--highlight">
            ...
            <p className="deploy-card-body">
              Unzip the file, then drag the folder onto Netlify Drop — your site
              is live in seconds. No account needed for a temporary URL.
            </p>
            <ol className="deploy-card-steps">
              <li>
                Unzip <code>portfolio-site.zip</code>
              </li>
          ...
          <div className="deploy-card">
            ...
            <p className="deploy-card-body">
              Unzip, push to GitHub, then connect Vercel or Cloudflare Pages for
          ...
          <div className="deploy-card deploy-card--muted">
            ...
            <p className="deploy-card-body">
              Direct integration with GitHub + Netlify/Vercel — push a button
              and your portfolio deploys automatically.
            </p>
        ...
        <p className="export-note">
          The ZIP also includes <code>portfolio-data.json</code> — keep this
          file to re-edit your portfolio later. Click <strong>Import</strong> in
          the builder to restore your data.
        </p>
        ...
        <div className="export-support">
          <p className="export-support-text">
            APortfolioApp is free, and always will be. If it saved you time, a
            small support means a lot.
          </p>
          <div className="export-support-btns">
            <a
              href="https://www.patreon.com/c/UnrealPatr?vanity=user"
              target="_blank"
              rel="noopener noreferrer"
              className="export-support-btn export-support-btn--patreon"
            >
              Support on Patreon
            </a>
            <a
              href="https://studio.buymeacoffee.com/dashboard"
              target="_blank"
              rel="noopener noreferrer"
              className="export-support-btn export-support-btn--bmc"
            >
              ☕ Buy me a coffee
            </a>
          </div>
